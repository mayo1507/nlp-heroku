...
def load_data(news,nlp):
   if news =="NY Times":
       ...
       if nlp =="Intro":
           ...
           image1 = Image.open(r'C:\Users\Domagoj\Desktop\FSB\1. PREDDIPLOMSKI STUDIJ\4. godina zimski\7. semestar\Završni projekt\New-York-Times-logo-500x281.jpg')
           st.write( " ")
           st.image(image1, width=300)
           st.write(" ")
           st.write(" ")
           st.write(" ")
           image = Image.open(r'C:\Users\Domagoj\Desktop\FSB\1. PREDDIPLOMSKI STUDIJ\4. godina zimski\7. semestar\Završni projekt\nytimes-building-ap-img.jpg')
